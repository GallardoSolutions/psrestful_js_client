...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PsDomainModelProductDataCommonLocation', function() {
      beforeEach(function() {
        instance = new PsResTfulServiceApi.PsDomainModelProductDataCommonLocation();
      });
      ...
      it('should create an instance of PsDomainModelProductDataCommonLocation', function() {
        ...
        expect(instance).to.be.a(PsResTfulServiceApi.PsDomainModelProductDataCommonLocation);
      });
