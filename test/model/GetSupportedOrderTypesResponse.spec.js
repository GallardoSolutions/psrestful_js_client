  ...
  describe('(package)', function() {
    describe('GetSupportedOrderTypesResponse', function() {
      ...
      it('should have the property supportedOrderTypes (base name: "supportedOrderTypes")', function() {
        // TODO: update the code to test the property supportedOrderTypes
        expect(instance).to.have.property('supportedOrderTypes');
        // expect(instance.supportedOrderTypes).to.be(expectedValueLiteral);
      });
