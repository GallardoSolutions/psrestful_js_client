...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ThirdPartyAccount', function() {
      beforeEach(function() {
        instance = new PsResTfulServiceApi.ThirdPartyAccount();
      });

      it('should create an instance of ThirdPartyAccount', function() {
        // TODO: update the code to test ThirdPartyAccount
        expect(instance).to.be.a(PsResTfulServiceApi.ThirdPartyAccount);
      });
