...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ContactDetailsInput', function() {
      beforeEach(function() {
        instance = new PsResTfulServiceApi.ContactDetailsInput();
      });

      it('should create an instance of ContactDetailsInput', function() {
        // TODO: update the code to test ContactDetailsInput
        expect(instance).to.be.a(PsResTfulServiceApi.ContactDetailsInput);
      });
