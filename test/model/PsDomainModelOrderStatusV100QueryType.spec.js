...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PsDomainModelOrderStatusV100QueryType', function() {
      beforeEach(function() {
        instance = PsResTfulServiceApi.PsDomainModelOrderStatusV100QueryType;
      });

      it('should create an instance of PsDomainModelOrderStatusV100QueryType', function() {
        // TODO: update the code to test PsDomainModelOrderStatusV100QueryType
