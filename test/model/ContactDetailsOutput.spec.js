...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ContactDetailsOutput', function() {
      beforeEach(function() {
        instance = new PsResTfulServiceApi.ContactDetailsOutput();
      });

      it('should create an instance of ContactDetailsOutput', function() {
        // TODO: update the code to test ContactDetailsOutput
        expect(instance).to.be.a(PsResTfulServiceApi.ContactDetailsOutput);
      });
