...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MediaDateModified', function() {
      beforeEach(function() {
        instance = new PsResTfulServiceApi.MediaDateModified();
      });

      it('should create an instance of MediaDateModified', function() {
        // TODO: update the code to test MediaDateModified
        expect(instance).to.be.a(PsResTfulServiceApi.MediaDateModified);
      });
