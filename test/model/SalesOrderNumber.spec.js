...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SalesOrderNumber', function() {
      beforeEach(function() {
        instance = new PsResTfulServiceApi.SalesOrderNumber();
      });

      it('should create an instance of SalesOrderNumber', function() {
        // TODO: update the code to test SalesOrderNumber
        expect(instance).to.be.a(PsResTfulServiceApi.SalesOrderNumber);
      });
