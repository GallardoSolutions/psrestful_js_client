...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('FobPointsResponse', function() {
      beforeEach(function() {
        instance = new PsResTfulServiceApi.FobPointsResponse();
      });

      it('should create an instance of FobPointsResponse', function() {
        // TODO: update the code to test FobPointsResponse
        expect(instance).to.be.a(PsResTfulServiceApi.FobPointsResponse);
      });
