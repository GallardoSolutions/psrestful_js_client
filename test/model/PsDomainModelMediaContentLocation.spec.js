...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PsDomainModelMediaContentLocation', function() {
      beforeEach(function() {
        instance = new PsResTfulServiceApi.PsDomainModelMediaContentLocation();
      });

      it('should create an instance of PsDomainModelMediaContentLocation', function() {
        // TODO: update the code to test PsDomainModelMediaContentLocation
        expect(instance).to.be.a(PsResTfulServiceApi.PsDomainModelMediaContentLocation);
      });
