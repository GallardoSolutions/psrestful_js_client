...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PsDomainModelOsnCommonQueryType', function() {
      beforeEach(function() {
        instance = PsResTfulServiceApi.PsDomainModelOsnCommonQueryType;
      });

      it('should create an instance of PsDomainModelOsnCommonQueryType', function() {
        // TODO: update the code to test PsDomainModelOsnCommonQueryType
