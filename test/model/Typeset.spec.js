...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Typeset', function() {
      beforeEach(function() {
        instance = new PsResTfulServiceApi.Typeset();
      });

      it('should create an instance of Typeset', function() {
        // TODO: update the code to test Typeset
        expect(instance).to.be.a(PsResTfulServiceApi.Typeset);
      });
      ...
      it('should have the property font (base name: "font")', function() {
        // TODO: update the code to test the property font
        expect(instance).to.have.property('font');
        // expect(instance.font).to.be(expectedValueLiteral);
      });
