...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetIssueResponseV200', function() {
      beforeEach(function() {
        instance = new PsResTfulServiceApi.GetIssueResponseV200();
      });

      it('should create an instance of GetIssueResponseV200', function() {
        // TODO: update the code to test GetIssueResponseV200
        expect(instance).to.be.a(PsResTfulServiceApi.GetIssueResponseV200);
      });
