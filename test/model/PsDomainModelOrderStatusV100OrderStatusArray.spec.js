...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PsDomainModelOrderStatusV100OrderStatusArray', function() {
      beforeEach(function() {
        instance = new PsResTfulServiceApi.PsDomainModelOrderStatusV100OrderStatusArray();
      });
      ...
      it('should create an instance of PsDomainModelOrderStatusV100OrderStatusArray', function() {
        ...
        expect(instance).to.be.a(PsResTfulServiceApi.PsDomainModelOrderStatusV100OrderStatusArray);
      });
