  ...
  describe('(package)', function() {
    describe('GetVoidedResponse', function() {
      ...
      it('should have the property voidedInvoiceArray (base name: "VoidedInvoiceArray")', function() {
        // TODO: update the code to test the property voidedInvoiceArray
        expect(instance).to.have.property('voidedInvoiceArray');
        // expect(instance.voidedInvoiceArray).to.be(expectedValueLiteral);
      });
