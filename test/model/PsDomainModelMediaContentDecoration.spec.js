...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PsDomainModelMediaContentDecoration', function() {
      beforeEach(function() {
        instance = new PsResTfulServiceApi.PsDomainModelMediaContentDecoration();
      });

      it('should create an instance of PsDomainModelMediaContentDecoration', function() {
        // TODO: update the code to test PsDomainModelMediaContentDecoration
        expect(instance).to.be.a(PsResTfulServiceApi.PsDomainModelMediaContentDecoration);
      });
