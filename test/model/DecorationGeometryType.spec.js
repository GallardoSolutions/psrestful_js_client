...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DecorationGeometryType', function() {
      beforeEach(function() {
        instance = PsResTfulServiceApi.DecorationGeometryType;
      });

      it('should create an instance of DecorationGeometryType', function() {
        // TODO: update the code to test DecorationGeometryType
